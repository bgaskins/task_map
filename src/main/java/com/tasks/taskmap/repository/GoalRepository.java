...
public interface GoalRepository extends JpaRepository<Goal, Long>{
	...
	public Optional<Goal> createMovie(@Param("goal_id") Long goalId,
	...
	public Optional<Goal> updateMovie(@Param("id") Long id);
	
	@Query(value = "DELETE FROM goals WHERE user_id = :goalId", nativeQuery = true)
	public Optional<Goal> deleteMovie(@Param("goalId") Long goalId);
}
